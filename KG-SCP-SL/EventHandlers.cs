...
namespace KG_SCP_SL
{
    public class EventHandlers
    {
        ...
        public void OnWarheadStart(bool isAutomatic, KGPlayer player, bool isResumed)
        {
            if (player == null)
        ...
        public void OnWarheadStop(KGPlayer player)
        {
            if (player == null)
        ...
        public void OnPlayerMuted(KGPlayer player, bool isIntercom)
        {
        ...
        public void OnPlayerUnmuted(KGPlayer player, bool isIntercom)
        {
        ...
        public void OnPlayerGameconsoleCommand(KGPlayer player, string command, string[] arguments)
        {
        ...
        {
             // Log.Info($"&7[&2Console&7]&r Server ussed command &6{command}&r{(arguments.Length != 0 ? $" with arguments &6{string.Join(", ", arguments)}&r" : string.Empty)}");
        }
        ...
        public void OnPlayerEnterPocketDimension(KGPlayer player)
        {
        ...
        public void OnPlayerExitPocketDimension(KGPlayer player, bool isSuccsefull)
        {
            // Log.Info($"Player &6{player.Nickname}&r (&6{player.UserId}&r) {(isSuccsefull ? "escaped" : "died while escaping")} pocket dimension");
        }

        [PluginEvent(ServerEventType.PlayerThrowProjectile)]
        public void OnPlayerThrowProjectile(KGPlayer player, ThrowableItem item, ThrowableItem.ProjectileSettings projectileSettings, bool fullForce)
        {
        ...
        public void OnPlayerInteractDoor(KGPlayer player, DoorVariant door, bool canOpen)
        {
        ...
        public void OnScp914Activate(KGPlayer player, Scp914KnobSetting knobSetting)
        {
        ...
        public void OnScp914KnobChange(KGPlayer player, Scp914KnobSetting knobSetting, Scp914KnobSetting previousKnobSetting)
        {
        ...
        public void OnScp914UpgradeInventory(KGPlayer player, ItemBase item, Scp914KnobSetting knobSetting)
        {
        ...
        public void OnScp106Stalking(KGPlayer player, bool activate)
        {
        ...
        public void OnScp173PlaySound(KGPlayer player, Scp173AudioPlayer.Scp173SoundId soundId)
        {
        ...
        public void OnScp173BreakneckSpeeds(KGPlayer player, bool activate)
        {
        ...
        public void OnScp173NewObserver(KGPlayer player, KGPlayer target)
        {
        ...
        public void OnScp173SnapPlayer(KGPlayer player, KGPlayer target)
        {
        ...
        public void OnScp173CreateTantrum(KGPlayer player)
        {
        ...
        public void OnScp939CreateAmnesticCloud(KGPlayer player)
        {
        ...
        public void OnScp939Lunge(KGPlayer player, Scp939LungeState state)
        {
        ...
        public void OnScp939Attack(KGPlayer player, IDestructible target)
        {
            if (!ReferenceHub.TryGetHubNetID(target.NetworkId, out ReferenceHub hub)) return;

            KGPlayer targetPlayer = Player.Get<KGPlayer>(hub);
        ...
        public void OnScp079GainExperience(KGPlayer player, int amount, Scp079HudTranslation reason)
        {
        ...
        public void OnScp079LevelUpTier(KGPlayer player, int tier)
        {
        ...
        public void OnScp079UseTesla(KGPlayer player, TeslaGate tesla)
        {
        ...
        public void OnScp079LockdownRoom(KGPlayer player, RoomIdentifier room)
        {
        ...
        public void OnScp079CancelRoomLockdown(KGPlayer player, RoomIdentifier room)
        {
        ...
        public void OnScp079LockDoor(KGPlayer player, DoorVariant door)
        {
        ...
        public void OnScp079UnLockDoor(KGPlayer player, DoorVariant door)
        {
        ...
        public void OnScp079BlackoutZone(KGPlayer player, FacilityZone zone)
        {
        ...
        public void OnScp079BlackoutRoom(KGPlayer player, RoomIdentifier room)
        {
        ...
        public void OnScp049ResurrectBody(KGPlayer player, KGPlayer target, BasicRagdoll body)
        {
        ...
        public void OnScp079ChangedCamera(KGPlayer player, Scp079Camera camera)
        {
        ...
        public void OnScp049StartResurrectingBody(KGPlayer player, KGPlayer target, BasicRagdoll body, bool canResurrect)
        {
        ...
        public void OnScp106TeleportPlayer(KGPlayer player, KGPlayer target)
        {
        ...
        public void OnScp096AddTarget(KGPlayer player, KGPlayer target, bool isForLooking)
        {
        ...
        public void OnScp096Enrage(KGPlayer player, float initialDuration)
        {
        ...
        public void OnScp096CalmDown(KGPlayer player, Scp096RageState rageState)
        {
        ...
        public void OnScp096Charge(KGPlayer player)
        {
        ...
        public void OnScp096PryGate(KGPlayer player, PryableDoor gate)
        {
        ...
        public void OnPlayerGameconsoleCommandExecuted(KGPlayer player, string command, string[] arguments, bool result, string response)
        {
        ...
        public void OnPlayerPreCoinFlip(KGPlayer player)
        {
            // Log.Info($"&rPlayer &6{player.Nickname}&r (&6{player.UserId}&r) flipped the coin (PreCoinFlip event).");
        }

        [PluginEvent(ServerEventType.PlayerCoinFlip)]
        public void OnPlayerCoinFlip(KGPlayer player, bool isTails)
        {
        ...
        public void OnPlayerInteractGenerator(KGPlayer player, Scp079Generator generator, Scp079Generator.GeneratorColliderId colliderId)
        {
        ...
        public void OnScp914InventoryItemUpgraded(KGPlayer player, ItemBase item, Scp914KnobSetting knobSetting)
        {
        ...
        public void OnScp914ProcessPlayer(KGPlayer player, Scp914KnobSetting knobSetting, Vector3 outPosition)
        {
